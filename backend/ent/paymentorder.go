...
// QueryBalanceLedger queries the "balance_ledger" edge of the PaymentOrder entity.
func (_m *PaymentOrder) QueryBalanceLedger() *UserBalanceLedgerQuery {
	return NewPaymentOrderClient(_m.config).QueryBalanceLedger(_m)
}
