...
// was not loaded in eager-loading.
func (e UserEdges) BalanceLedgerOrErr() ([]*UserBalanceLedger, error) {
	if e.loadedTypes[10] {
...
// QueryBalanceLedger queries the "balance_ledger" edge of the User entity.
func (_m *User) QueryBalanceLedger() *UserBalanceLedgerQuery {
	return NewUserClient(_m.config).QueryBalanceLedger(_m)
}
